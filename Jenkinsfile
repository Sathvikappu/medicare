node {
    ...
    stage ('code checkout'){
        ...
        git 'https://github.com/Sathvikappu/star-agile-health-care.git'
        }
        catch(Exception e){
            ...
            Thanks,''', subject: 'The jenkis Job ${JOB_NAME} is Failed ', to: 'sathvikgowdap@gmail.com'
        }
    }
    ...
    stage('Build the DockerImage of the application'){
        ...
        sh "${dockerCMD} build -t Sathvikappu/medicure:${tagName} ."
    ...
    stage('push the docker image to dockerhub'){
        ...
        // some block
        sh "${dockerCMD} login -u Sathvikappu -p ${DockerPassword}"
        sh "${dockerCMD} push Sathvikappu/medicure:${tagName}"
        }
    }
